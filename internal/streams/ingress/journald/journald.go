...
type IngressSubjectJournald struct {
	...
	COM_GITHUB_LOGUNIFIER_APPLICATION_STACK       string `json:"COM_GITHUB_LOGUNIFIER_APPLICATION_STACK"`
	COM_GITHUB_LOGUNIFIER_APPLICATION_NAMESPACE   string `json:"COM_GITHUB_LOGUNIFIER_APPLICATION_NAMESPACE"`
...
func (r *IngressSubjectJournald) extractServiceMetadata(ecs *model.EcsLogEntry) {
	...
	if len(r.COM_GITHUB_LOGUNIFIER_APPLICATION_STACK) > 0 {
		ecs.Service.Stack = r.COM_GITHUB_LOGUNIFIER_APPLICATION_STACK
	} else {
