...
type Constants_Ecs struct {
	...
	Version *string `protobuf:"bytes,1,req,name=version,def=1.0" json:"version,omitempty"`
}

// Default values for Constants_Ecs fields.
const (
	Default_Constants_Ecs_Version = string("1.0")
)
...
var file_pkg_model_ecsconstants_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x02, 0x28, 0x09, 0x3a, 0x03, 0x31, 0x2e, 0x30, 0x52,
