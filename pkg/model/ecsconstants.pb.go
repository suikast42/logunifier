...
// proto2 allows default values and proto3 not.
// All fields  that defines constants should defined here
...
type Constants_Ecs struct {
	...
	Version *string `protobuf:"bytes,1,req,name=version,def=1.1" json:"version,omitempty"`
}

// Default values for Constants_Ecs fields.
const (
	Default_Constants_Ecs_Version = string("1.1")
)
...
func (x *Constants_Ecs) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
var file_pkg_model_ecsconstants_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05,
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x22, 0x31, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x73, 0x74, 0x61, 0x6e,
	0x74, 0x73, 0x1a, 0x24, 0x0a, 0x03, 0x45, 0x63, 0x73, 0x12, 0x1d, 0x0a, 0x07, 0x76, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x02, 0x28, 0x09, 0x3a, 0x03, 0x31, 0x2e, 0x31, 0x52,
	0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x56, 0x0a, 0x25, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_pkg_model_ecsconstants_proto_goTypes = []any{
	(*Constants)(nil),     // 0: model.Constants
	(*Constants_Ecs)(nil), // 1: model.Constants.Ecs
}
...
func file_pkg_model_ecsconstants_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_model_ecsconstants_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pkg_model_ecsconstants_proto_msgTypes[1].Exporter = func(v any, i int) any {
